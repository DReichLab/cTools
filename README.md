...
Currently, there are 340 samples in SGDP lite: <br />

- FullyPublicGeneral: 163 samples (including the above ancient genomes) <br />
...
Outputs: .hetfa (fasta format), hetfa.fai,.mask.fa, .mask.fa.fai<br />
